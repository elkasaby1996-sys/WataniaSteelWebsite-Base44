...
const serviceTypes = [
  ...
  { value: 'straight_bar', label: 'Straight Bar Supply' },
  { value: 'mesh', label: 'Welded Mesh' },
...
const urgencyLevels = [
  ...
  { value: 'express', label: 'Express (24-48 hours)' },
];
      ...
      <div className="min-h-screen pt-20 bg-gray-50 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Thank you for your inquiry. Our team will review your request and get back to you 
    ...
    <div className="min-h-screen pt-20 bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-[#1A1A1A] to-[#2d2d2d] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-[#7B1F32] font-semibold tracking-wide uppercase text-sm">Get a Quote</span>
            <h1 className="text-4xl lg:text-5xl font-bold text-white mt-4 mb-4">
              Request a Quotation
            </h1>
            <p className="text-xl text-gray-400 max-w-2xl">
              Upload your drawings or describe your requirements. We'll get back to you with a 
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <User className="w-5 h-5 text-[#7B1F32]" />
                Contact Information
              </h2>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Briefcase className="w-5 h-5 text-[#7B1F32]" />
                Project Details
              </h2>
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    placeholder="Describe your requirements, specifications, or any special instructions..."
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Upload className="w-5 h-5 text-[#7B1F32]" />
              ...
              >
                ...
                <p className="text-gray-500 text-sm">
                  PDF, DWG, XLS, Images (Max 10MB each)
                </p>
                <input
                  id="file-upload"
                  type="file"
                  multiple
                  accept=".pdf,.dwg,.dxf,.xls,.xlsx,.jpg,.jpeg,.png"
                  ...
                  {files.map((file, index) => (
                    <div key={index} className="flex items-center justify-between bg-gray-50 rounded-xl p-4">
                      <div className="flex items-center gap-3">
                        <FileText className="w-5 h-5 text-[#7B1F32]" />
